    ...
    const DeleteModal = () => (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-neutral-800 rounded-lg p-6 max-w-md w-full mx-4">
                ...
                <p className="mb-6">
                    Are you sure you want to delete security personnel <span className="font-semibold">{personToDelete?.firstName} {personToDelete?.lastName}</span>? 
            ...
            <main className="flex-1 p-6 md:p-8 lg:p-10 overflow-y-auto">
                ...
                {loading ? (
                    <div className="flex justify-center items-center h-64">
                        <div className="text-xl text-neutral-400">Loading security personnel...</div>
                    </div>
                /* Error State */
                ) : error ? (
                ...
                /* No Security Personnel Found */
                     ...
                     <div className="text-center py-10 text-neutral-500">
                        No security personnel found. Click "Add Security Personnel" to add one.
                    </div>
                ) : (
